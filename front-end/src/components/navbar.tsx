  ...
  return (
    <div className="navbar">
      ...
      <div style={{position:"relative"}}>
        <button className="hambutton" aria-label="menu" onClick={()=>setOpen(v=>!v)}>☰</button>
        {open && (
          <div className="menu-dropdown" role="menu" onMouseLeave={()=>setOpen(false)}>
