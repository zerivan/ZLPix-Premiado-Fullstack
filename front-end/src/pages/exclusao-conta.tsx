        ...
        {token ? (
          ...
          <>
            <div className="space-y-4 text-sm text-blue-100 mb-6">
              <p>
                O ZLPix Premiado respeita os direitos dos usuários
                previstos na Lei Geral de Proteção de Dados (LGPD).
              </p>

              <p>
                Após o envio da solicitação, sua conta será
                encaminhada para análise da equipe responsável.
              </p>
              ...
              <p>
                Alguns dados poderão permanecer armazenados pelo
                período exigido por lei, especialmente para fins
                fiscais, contábeis, prevenção a fraudes, segurança
                da plataforma e cumprimento de obrigações legais.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/10 rounded-lg p-4">
                <label className="block mb-3">
                  <input
                    ...
                    onChange={() =>
                      setTipo(
                        "Excluir conta e dados permitidos"
                      )
                    }
                  />
                  <span className="ml-2">
                    Excluir conta e dados pessoais permitidos pela
                    legislação
                  </span>
                </label>
                ...
                <label className="block">
                  <input
                    ...
                    checked={
                      tipo ===
                      "Excluir conta mantendo dados exigidos por lei"
                    }
                    onChange={() =>
                      setTipo(
                        "Excluir conta mantendo dados exigidos por lei"
                  ...
                  />
                  <span className="ml-2">
                    Excluir conta mantendo apenas os dados
                    obrigatórios
                  </span>
                </label>
              </div>
              ...
              <button
                ...
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-bold py-3 rounded-full shadow-lg disabled:opacity-70"
              >
                {enviando
                  ? "Enviando..."
                  : enviado
