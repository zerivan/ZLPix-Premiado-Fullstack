...
export default function Resultados() { return ( <div className="font-display bg-background-light dark:bg-background-dark min-h-screen"> {/* Top App Bar */} <header className="sticky top-0 z-10 flex items-center justify-between bg-background-light/80 p-4 pb-2 backdrop-blur-sm dark:bg-background-dark/80"> <div className="flex size-12 shrink-0 items-center justify-start text-slate-800 dark:text-white"> <span className="material-symbols-outlined text-3xl">arrow_back</span> </div> <h1 className="flex-1 text-center text-lg font-bold leading-tight tracking-tight text-slate-900 dark:text-white">Resultados dos Sorteios</h1> <div className="size-12 shrink-0" /> </header>
...
<main className="flex-1 px-4 pb-24">
    ...
    <div className="py-4">
      <div className="flex w-full flex-col gap-3 sm:flex-row">
        ...
        <button className="flex h-12 shrink-0 items-center justify-center gap-x-2 rounded-full border border-slate-300 bg-slate-50 px-4 pr-3 text-slate-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200">
          <span className="material-symbols-outlined text-xl">calendar_month</span>
          <p className="text-sm font-medium leading-normal">Filtrar por data</p>
    ...
    <div className="flex flex-col gap-4">
      ...
      <article className="flex flex-col items-stretch justify-start gap-3 rounded-lg bg-white p-4 shadow-sm dark:bg-slate-900/70">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-lg font-bold leading-tight tracking-tight text-primary dark:text-sky-400">Sorteio Especial de Aniversário</p>
            <p className="text-sm font-normal leading-normal text-slate-500 dark:text-slate-400">Sorteio #5678 - 24 de Maio de 2024</p>
          </div>
          <span className="material-symbols-outlined text-2xl text-slate-400 dark:text-slate-500">more_vert</span>
        </div>
        ...
        <div className="rounded-lg bg-slate-100 p-3 dark:bg-slate-800">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {['05','15','25','35','50'].map((n) => (
              <span key={n} className="flex h-10 w-10 items-center justify-center rounded-full bg-primary font-bold text-white">{n}</span>
            ))}
          </div>
        </div>
        ...
        <button className="mt-2 flex h-10 w-full cursor-pointer items-center justify-center overflow-hidden rounded-full bg-slate-200 text-sm font-medium leading-normal text-slate-700 hover:bg-slate-300 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700">
  ...
  <div className="fixed bottom-0 left-0 right-0 p-4">
    <div className="mx-auto max-w-lg">
      <button className="flex h-14 w-full cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full bg-primary text-base font-bold leading-normal text-white shadow-lg shadow-primary/30">
