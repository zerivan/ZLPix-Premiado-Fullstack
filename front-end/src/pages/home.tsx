...
<p><strong>O bilhete é composto por 03 dezenas de 00 a 99.</strong></p>
<p>É permitido repetir dezenas. A data do sorteio constará no bilhete.</p>
<p>As dezenas são extraídas com base nos 5 primeiros prêmios da <strong>Loteria Federal</strong>, considerando apenas:</p>
<ul class="list-disc pl-5">
<li>Dezena inicial (dois primeiros números)</li>
<li>Dezena final (dois últimos números)</li>
</ul>
<p>Exemplo: 7590 → 75 e 90</p>
<p>Ganha quem acertar as 3 dezenas escolhidas.</p>
<p>Se ninguém acertar, o prêmio acumula para o próximo sorteio.</p>
<hr class="border-white/20"/>
<p class="text-center font-bold text-yellow-300">
🎯 Clique em Apostar e boa sorte!
</p>
`;
      ...
      <main className="flex-1 px-6 pt-6 space-y-8 flex flex-col items-center text-center">
        ...
        <div className="bg-white/10 rounded-2xl p-6 shadow-lg w-full max-w-md">
          ...
          <p className="text-sm text-white/90 mt-3 font-semibold">
            Apuração 100% vinculada aos resultados oficiais.
          </p>
        ...
        >
          ...
          <p className="text-yellow-300 font-bold text-sm">
            🎉 Agora é com você! Escolha suas três dezenas, confirme sua aposta e aguarde o sorteio oficial da Loteria Federal.
          </p>
        </motion.div>
          ...
          <AnimatePresence>
            {showInfo && (
              <motion.div
                ...
                className="bg-white/10 rounded-2xl p-5 shadow-lg w-full"
